...
Java_com_nexus_v4_LlamaEngine_nativeInit(JNIEnv *env, jobject, jstring nativeLibDir) {
...
Java_com_nexus_v4_LlamaEngine_nativeLoadModel(JNIEnv *env, jobject, jstring jmodelPath) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_nexus_v4_LlamaEngine_nativePrepare(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_nexus_v4_LlamaEngine_nativeSetSystemPrompt(JNIEnv *env, jobject, jstring jprompt) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_nexus_v4_LlamaEngine_nativeSendUserPrompt(JNIEnv *env, jobject, jstring jprompt, jint nPredict) {
    reset_short_term_states();
...
Java_com_nexus_v4_LlamaEngine_nativeGenerateNextToken(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_nexus_v4_LlamaEngine_nativeUnload(JNIEnv *, jobject) {
    reset_long_term_states();
    reset_short_term_states();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_nexus_v4_LlamaEngine_nativeShutdown(JNIEnv *, jobject) {
    llama_backend_free();
}
